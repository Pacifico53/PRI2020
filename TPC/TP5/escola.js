...
var servidor = http.createServer(function (req, res){
    ...
    if (req.method == 'GET') {
        if (req.url == '/') {
            ...
            res.write('<ul>');
            res.write('<li><a href=\"http://localhost:7777/alunos\">Lista de alunos</a></li>')
            res.write('<li><a href=\"http://localhost:7777/cursos\">Lista de cursos</a></li>')
            res.write('<li><a href=\"http://localhost:7777/instrumentos\">Lista de instrumentos</a></li>')
            res.write('</ul>');
            res.end();
        }
            ...
            axios.get('http://localhost:3000/alunos')
                .then((resp) => {
                    ...
                    alunos.forEach(a => {
                        ...
                        res.write(`<li><a href=\"http://localhost:7777/alunos/${a.id}"+"\">${a.id}, ${a.nome}</a></li>`); //TODO
            ...
            axios.get('http://localhost:3000/alunos/'+ num)
                .then((resp) => {
                    ...
                    res.write(`<p>Curso: <a href=\"http://localhost:7777/cursos/${aluno.curso}\">${aluno.curso}</a></p>`);
                    //console.log(aluno.curso);
                    res.write(`<p>Ano do Curso: ${aluno.anoCurso}</p>`);
                    res.write(`<p>Instrumento: ${aluno.instrumento}</a></p>`);

                    res.write('<p><a href=\"http://localhost:7777/alunos\">[Alunos]</a></p>');
                    res.write('<a href=\"http://localhost:7777/\">[Indice]</a>');
            ...
            axios.get('http://localhost:3000/cursos')
                .then((resp) => {
                    ...
                    res.write('<ul>');
                    cursos.forEach(a => {
                        res.write(`<li><a href=\"http://localhost:7777/cursos/${a.id}"+"\">${a.id}, ${a.designacao}</a></li>`); //FALTAM OS INSTRUMENTOS
            ...
            axios.get('http://localhost:3000/cursos/'+ i)
                .then((resp) => {
                    ...
                    res.write(`<p>Instrumento: ${aluno.instrumento}</a></p>`);
                    res.write('<p><a href=\"http://localhost:7777/cursos\">[Cursos]</a></p>');
                    res.write('<a href=\"http://localhost:7777/\">[Indice]</a>');
            ...
            axios.get('http://localhost:3000/instrumentos')
                .then((resp) => {
                    ...
                    instrumentos.forEach(a => {
                        ...
                        res.write(`<li><a href=\"http://localhost:7777/instrumentos/${a.id}" +"\">${a.id}, ${a["#text"]}</a></li>`); //FALTAM OS INSTRUMENTOS
            ...
            var i = req.url.split("/")[2];
            axios.get('http://localhost:7777/instrumentos?id='+ i)
                .then((resp) => {
                    res.writeHead(200, {
                        'Content-type': 'text/html; charset=utf-8'
                    })
                    ...
                    res.write('<p><a href=\"http://localhost:7777/instrumentos\">[Instrumentos]</a></p>');
                    res.write('<a href=\"http://localhost:7777/\">[Indice]</a>');
