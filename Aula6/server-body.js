    ...
    <html>
        ...
        <body>
            ...
            <form class="w3-container" action="/alunos" method="POST">
                ...
                <label class="w3-text-teal"><b>NÃºmero / Identificador</b></label>
    ...
    switch(req.method){
        ...
        case "POST":
            if(req.url == '/alunos'){
                ...
                res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                res.write('<p>Recebi um POST nÃ£o suportado.</p>')
                res.write('<p><a href="/">Voltar</a></p>')
                res.end()
            }
            break
...
console.log('Servidor Ã  escuta na porta 7779...')
